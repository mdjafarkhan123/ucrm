...
| 5 | V1 | Deliver Jobs-owned completion integration and Job Visits parity | Planned | Part 4c; Jobs Part 13a | Complete/uncomplete and Finish job/Add a return visit/Keep open use Jobs truth; compact Job card and Schedule show identical timing, assignment and status |
| 6a | V1.1 | Add Request-owned Assessments and Schedule-owned lightweight Events | Planned | Part 5; Request/Assessment readiness | Assessment selects/opens an existing Request; one-time timed/Anytime whole-team Event exists only through Schedule popover/modal with no assignment, privacy, client/property or address fields; no separate Event module |
