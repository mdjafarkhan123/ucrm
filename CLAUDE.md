...
8. **No duplicated UI.** Before designing or creating any part first of all check `src/lib/components` to know if any already exist, and reuse or extend an existing component when structure and behavior are the same.
