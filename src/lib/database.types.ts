...
export type Database = {
	...
	public: {
		Tables: {
			...
			communication_email_domains: {
				Row: {
					...
					provider_inbound_webhook_id: string | null;
			...
			communication_website_chat_authority_events: {
				Row: {
					actor_owner_email: string;
					after_state: Json;
					before_state: Json;
				...
				Relationships: [
					{
						foreignKeyName: 'communication_website_chat_authority_event_organization_id_fkey';
						columns: ['organization_id'];
						isOneToOne: false;
						referencedRelation: 'organizations';
						referencedColumns: ['id'];
					...
					{
						foreignKeyName: 'communication_website_chat_authority_events_widget_fk';
			...
			invoice_access_links: {
				...
				Relationships: [
					{
						foreignKeyName: 'invoice_access_links_invoice_fk';
						columns: ['organization_id', 'invoice_id'];
						isOneToOne: false;
						referencedRelation: 'invoices';
						referencedColumns: ['organization_id', 'id'];
					...
					{
						foreignKeyName: 'invoice_access_links_organization_id_fkey';
						columns: ['organization_id'];
						isOneToOne: false;
						referencedRelation: 'organizations';
						referencedColumns: ['id'];
			...
			job_command_receipts: {
				...
				Relationships: [
					{
						foreignKeyName: 'job_command_receipts_organization_id_fkey';
						columns: ['organization_id'];
						isOneToOne: false;
						referencedRelation: 'organizations';
						referencedColumns: ['id'];
			...
			job_events: {
				...
				Relationships: [
					{
						foreignKeyName: 'job_events_job_organization_fk';
						columns: ['organization_id', 'job_id'];
						isOneToOne: false;
						referencedRelation: 'job_list_rows';
						referencedColumns: ['organization_id', 'id'];
					...
					{
						foreignKeyName: 'job_events_organization_id_fkey';
						columns: ['organization_id'];
						isOneToOne: false;
						referencedRelation: 'organizations';
						referencedColumns: ['id'];
			...
			job_line_items: {
				...
				Relationships: [
					{
						foreignKeyName: 'job_line_items_image_fk';
					...
					{
						foreignKeyName: 'job_line_items_job_organization_fk';
						columns: ['organization_id', 'job_id'];
						isOneToOne: false;
						referencedRelation: 'job_list_rows';
						referencedColumns: ['organization_id', 'id'];
					...
					{
						foreignKeyName: 'job_line_items_organization_id_fkey';
						columns: ['organization_id'];
						isOneToOne: false;
						referencedRelation: 'organizations';
						referencedColumns: ['id'];
			...
			job_recurrence_rules: {
				...
				Relationships: [
					{
						foreignKeyName: 'job_recurrence_rules_job_organization_fk';
						columns: ['organization_id', 'job_id'];
						isOneToOne: false;
						referencedRelation: 'job_list_rows';
						referencedColumns: ['organization_id', 'id'];
					...
					{
						foreignKeyName: 'job_recurrence_rules_organization_id_fkey';
						columns: ['organization_id'];
						isOneToOne: false;
						referencedRelation: 'organizations';
						referencedColumns: ['id'];
			...
			job_report_access_links: {
				...
				Relationships: [
					{
						foreignKeyName: 'job_report_access_links_job_fk';
						columns: ['organization_id', 'job_id'];
						isOneToOne: false;
						referencedRelation: 'job_list_rows';
						referencedColumns: ['organization_id', 'id'];
					...
					{
						foreignKeyName: 'job_report_access_links_organization_id_fkey';
						columns: ['organization_id'];
						isOneToOne: false;
						referencedRelation: 'organizations';
						referencedColumns: ['id'];
			...
			job_report_checklist_items: {
				...
				Relationships: [
					{
						foreignKeyName: 'job_report_checklist_items_item_fk';
					...
					{
						foreignKeyName: 'job_report_checklist_items_job_fk';
						columns: ['organization_id', 'job_id'];
						isOneToOne: false;
						referencedRelation: 'job_list_rows';
						referencedColumns: ['organization_id', 'id'];
					...
					{
						foreignKeyName: 'job_report_checklist_items_organization_id_fkey';
						columns: ['organization_id'];
						isOneToOne: false;
						referencedRelation: 'organizations';
						referencedColumns: ['id'];
					...
					{
						foreignKeyName: 'job_report_checklist_items_visit_fk';
						columns: ['organization_id', 'visit_id'];
						isOneToOne: false;
						referencedRelation: 'job_visits';
						referencedColumns: ['organization_id', 'id'];
			...
			job_report_photos: {
				...
				Relationships: [
					...
					{
						foreignKeyName: 'job_report_photos_job_fk';
						columns: ['organization_id', 'job_id'];
						isOneToOne: false;
						referencedRelation: 'job_list_rows';
						referencedColumns: ['organization_id', 'id'];
			...
			job_reports: {
				...
				Relationships: [
					...
					{
						foreignKeyName: 'job_reports_organization_id_fkey';
						columns: ['organization_id'];
						isOneToOne: false;
						referencedRelation: 'organizations';
						referencedColumns: ['id'];
					...
					{
						foreignKeyName: 'job_reports_signature_fk';
						columns: ['organization_id', 'signature_id'];
						isOneToOne: false;
						referencedRelation: 'job_signatures';
						referencedColumns: ['organization_id', 'id'];
					}
				];
			};
			...
			job_visit_assignments: {
				...
				Relationships: [
					{
						foreignKeyName: 'job_visit_assignments_member_fk';
						columns: ['organization_id', 'user_id'];
						isOneToOne: false;
						referencedRelation: 'organization_members';
						referencedColumns: ['organization_id', 'user_id'];
					...
					{
						foreignKeyName: 'job_visit_assignments_organization_id_fkey';
						columns: ['organization_id'];
						isOneToOne: false;
						referencedRelation: 'organizations';
						referencedColumns: ['id'];
			...
			job_visits: {
				...
				Relationships: [
					{
						foreignKeyName: 'job_visits_job_organization_fk';
						columns: ['organization_id', 'job_id'];
						isOneToOne: false;
						referencedRelation: 'job_list_rows';
						referencedColumns: ['organization_id', 'id'];
					...
					{
						foreignKeyName: 'job_visits_organization_id_fkey';
						columns: ['organization_id'];
						isOneToOne: false;
						referencedRelation: 'organizations';
						referencedColumns: ['id'];
			...
			jobs: {
				Row: {
					...
					arrival_window_style: string | null;
				...
				Relationships: [
					{
						foreignKeyName: 'jobs_client_organization_fk';
						columns: ['organization_id', 'client_id'];
						isOneToOne: false;
						referencedRelation: 'clients';
						referencedColumns: ['organization_id', 'id'];
					...
					{
						foreignKeyName: 'jobs_property_organization_fk';
					...
					{
						foreignKeyName: 'jobs_quote_organization_fk';
						columns: ['organization_id', 'quote_id'];
						isOneToOne: false;
						referencedRelation: 'quotes';
						referencedColumns: ['organization_id', 'id'];
					...
					{
						foreignKeyName: 'jobs_tax_rate_organization_fk';
						columns: ['organization_id', 'tax_rate_id'];
						isOneToOne: false;
						referencedRelation: 'organization_tax_rates';
						referencedColumns: ['organization_id', 'id'];
		...
		Functions: {
			...
			acquire_communication_worker_lease: {
			...
			get_communication_email_worker_health: { Args: never; Returns: Json };
			...
			preview_job_recurrence: { Args: { rule: Json }; Returns: Json };
			...
			quote_line_money: { Args: { target_version_id: string }; Returns: Json };
			quote_ready_for_job: {
				Args: { target_quote_id: string };
				Returns: boolean;
			};
			...
			record_communication_worker_wake_dispatch: {
				Args: {
					p_job_name: string;
					p_net_request_id: number;
					p_wake_correlation_id: string;
			...
			record_communication_worker_wake_result: {
				Args: {
					...
					p_retried?: number;
					p_route_outcome: string;
					p_stale_claims_quarantined?: number;
					p_started_at: string;
					p_submission_unknown?: number;
					p_submitted?: number;
					p_wake_correlation_id: string;
					p_worker_name: string;
				};
