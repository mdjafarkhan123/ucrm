...
| 6c   | Invoice contract/disclaimer: enter, save, edit, display on the customer invoice, mirroring the shipped quote disclaimer. Separate from payment terms; content frozen when the invoice is issued. | Planned — Jafar flagged 2026-09-06 as an invoice-contract gap (already in the behavior contract, missing from implementation) | Part 4b (detail page), 6a (customer document); Quote disclaimer pattern | Draft can enter/edit; issued bill freezes it; customer document shows it; separate from terms |
