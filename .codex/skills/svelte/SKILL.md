...
- `svelte-code-writer/SKILL.md` — CLI access to Svelte documentation and autofixer tools.
- `svelte-core-bestpractices/SKILL.md` — Svelte 5 patterns for reactivity, events, snippets, styling, context, and performance.

When editing or reviewing Svelte code, use both related skills when available.
