...
- **Reason:** `Design/Request Details.jpg` draws a separate Labor block, and Part 2 originally built one that
  ...
  app does not have. The typed Labor block was removed entirely (see
  `Memory/campaigns/quotes/parts/02-pricing-and-request-carry-forward.md`, "Session 2 findings and rebuild").
