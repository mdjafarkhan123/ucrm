...
| 5c   | Jobs 11c (payment schedule installments, per-visit amounts) and progress invoicing from an installment | Planned — dependency-ready (5a ✅, Jobs 11a ✅ complete 2026-09-01); unscoped. Needs Jobber/GHL research on payment schedules + progress invoicing, then Jafar approval, before planning. Last open part of the campaign. | 5a; Jobs 11a | Installments total the job, issued installments lock, each bills once |
